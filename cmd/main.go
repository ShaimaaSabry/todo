...
func main() {
	...
	handler := api.NewTodoApiHandler(todoRepository)
	...
	http.HandleFunc(
		...
		func(w http.ResponseWriter, request *http.Request) {
			...
			case http.MethodGet:
				...
				handler.GetTodosHandler(w, request)
			case http.MethodPost:
				handler.AddTodoHandler(w, request)
			default:
	...
	http.HandleFunc(
		...
		func(w http.ResponseWriter, request *http.Request) {
			...
			case "check":
				...
				handler.CheckTodoHandler(w, request, taskID)
			case "uncheck":
				handler.UncheckTodoHandler(w, request, taskID)
			default:
				http.NotFound(w, request)
			}
		},
